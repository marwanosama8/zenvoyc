...
use App\Filament\User\Resources\CustomerResource\RelationManagers\CustomerContactsRelationManager;
use App\Filament\User\Resources\CustomerResource\Pages;
        ...
        return $table
            ->columns([
                ...
                Tables\Columns\ViewColumn::make('token')
                    ...
                    ->label(__('customer.field.copy_url')),
