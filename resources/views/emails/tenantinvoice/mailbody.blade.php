                                                ...
                                                <table width="600" cellpadding="0" cellspacing="0" border="0" class="container">
                                                    ...
                                                    <tr>
                                                        <td align="center" class="hund ripplelink" width="600">
                                                            <img align="center" width="600" style="border-radius: 3px 3px 0px 0px; width: 100%; max-width: 600px!important" class="hund" src="https://www.solution-work.de/images/invoice.png">
                                                        </td>
                                                    </tr>
                                                    <!-- END HEADER IMAGE -->
                                                    <!-- START BODY COPY -->
                                                    ...
                                                    <tr>
                                                        <td class="td-padding" align="left" style="font-family: {{ $normal_style }}; color: #212121!important; font-size: 16px; line-height: 24px; padding-top: 18px; padding-left: 18px!important; padding-right: 18px!important; padding-bottom: 0px!important; mso-line-height-rule: exactly; mso-padding-alt: 18px 18px 0px 18px;">
                                                            ...
                                                            <p>Vielen Dank f&uuml;r die bisherige gute Zusammenarbeit.</p>
                                                            <p>Anbei finden Sie die aktuelle Rechnung &uuml;ber den letzten Abrechnungszeitraum im PDF Format.</p>
                                                            <p>Ich m&ouml;chte Sie bitten, die angeh&auml;ngte Rechnung zu &uuml;berpr&uuml;fen und uns bei eventuellen Unstimmigkeiten oder Fragen direkt zu kontaktieren.</p>
                                                            <p>Bitte bezahlen Sie die Rechnung im genannten Zeitraum.</p>
                                                            <p>Wir freuen uns auf eine weiterhin gute Zusammenarbeit.</p>
                                                            <p>Mit freundlichen Gr&uuml;&szlig;en,</p>
                                                            <p style="font-family: 'Courgette', cursive; color: #212121!important; font-size: 28px;">Michael Klein, Inhaber</p>
                                                        </td>
                                                    </tr>
                                                    <!-- END BODY COPY -->
