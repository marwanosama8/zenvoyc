                                                ...
                                                <table width="600" cellpadding="0" cellspacing="0" border="0" class="container">
                                                    ...
                                                    <tr>
                                                        <td align="center" class="hund ripplelink" width="600">
                                                            <img align="center" width="300" style="border-radius: 3px 3px 0px 0px; width: 100%; max-width: 300px!important; margin-top:10px;" class="hund" src="{{ asset('component/invoice/invoice-01.png') }}">
                                                        </td>
                                                    </tr>
                                                    <!-- END HEADER IMAGE -->
                                                    <!-- START BODY COPY -->
                                                    <tr>
                                                        <td class="td-padding" align="left" style="font-family: {{ $special_style }}; color: #212121!important; font-size: 24px; line-height: 30px; padding-top: 18px; padding-left: 18px!important; padding-right: 18px!important; padding-bottom: 0px!important; mso-line-height-rule: exactly; mso-padding-alt: 18px 18px 0px 13px;">
                                                            Rechnung: RG {{ $invoice->rgnr }} vom {{ $invoice->date_origin }}
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td class="td-padding" align="left" style="font-family: {{ $normal_style }}; color: #212121!important; font-size: 16px; line-height: 24px; padding-top: 18px; padding-left: 18px!important; padding-right: 18px!important; padding-bottom: 0px!important; mso-line-height-rule: exactly; mso-padding-alt: 18px 18px 0px 18px;">
                                                            ...
                                                            <p>im Anhang übersenden wir Ihnen Ihre Rechnung vom {{$invoice->date_origin}} als PDF-Dokument.</p>
                                                            ...
                                                            <p>Sie haben Fragen? Gerne können Sie uns anrufen damit wir ihre Fragen schnellstmöglich klären.</p>
