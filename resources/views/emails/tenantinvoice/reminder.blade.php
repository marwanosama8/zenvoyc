...
<head>
    ...
    <title>Solution-Work Rechnung</title>
    <link href="https://fonts.googleapis.com/css?family=Courgette|Quantico|Roboto+Condensed|Roboto+Mono&display=swap" rel="stylesheet">
    <?php
    $normal_style = '\'Roboto Mono\', monospaced';
    $special_style = '\'Quantico\'';
    ?>
    <style type="text/css">
...
<table width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="#eeeeee">
    ...
    <div style="display: none; max-height: 0px; overflow: hidden;">
        Eine neue Rechnung von Solution-Work
    </div>
                                                ...
                                                <table width="600" cellpadding="0" cellspacing="0" border="0" class="container" align="center">
                                                    ...
                                                    <tr>
                                                        <td align="center" class="hund" width="600">
                                                            <img src="{{ asset('component/invoice/logo.png') }}" alt="Solution-Work" border="0" style="max-width: 300px; display:block; ">
                                                        </td>
                                                    </tr>
                                                ...
                                                <table width="600" cellpadding="0" cellspacing="0" border="0" class="container">
                                                    ...
                                                    <tr>
                                                        <td align="center" class="hund ripplelink" width="600">
                                                            <img align="center" width="300" style="border-radius: 3px 3px 0px 0px; width: 100%; max-width: 300px!important; margin-top:10px;" class="hund" src="{{ asset('component/invoice/invoice-04.png') }}">
                                                        </td>
                                                    </tr>
                                                    <!-- END HEADER IMAGE -->
                                                    <!-- START BODY COPY -->
                                                    <tr>
                                                        <td class="td-padding" align="left" style="font-family: {{ $special_style }}; color: #212121!important; font-size: 24px; line-height: 30px; padding-top: 18px; padding-left: 18px!important; padding-right: 18px!important; padding-bottom: 0px!important; mso-line-height-rule: exactly; mso-padding-alt: 18px 18px 0px 13px;">
                                                            Erinnerung an unsere Rechnung: RG {{ $invoice->rgnr }} vom {{ $invoice->date_origin }}
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td class="td-padding" align="left" style="font-family: {{ $normal_style }}; color: #212121!important; font-size: 16px; line-height: 24px; padding-top: 18px; padding-left: 18px!important; padding-right: 18px!important; padding-bottom: 0px!important; mso-line-height-rule: exactly; mso-padding-alt: 18px 18px 0px 18px;">
                                                            <p>Hallo {{$invoice->Customer->contact}},</p>
                                                            <p>leider haben wir für unsere Rechnung mit der Rechnungsnummer RG {{ $invoice->rgnr }} vom {{ $invoice->date_origin }} bis heute keinen Zahlungseingang verzeichnen können.</p>
                                                            <p>Sicherlich haben Sie übersehen, dass die oben genannte Rechnung noch nicht ausgeglichen wurde. Es kann jedem Mal passieren, dass man einen Zahlungstermin unbeabsichtigt aus den Augen verliert.</p>
                                                            <p>Ich bitte Sie daher höflich um Ausgleich der Rechnung in Höhe von {{number_format($invoice->getTotalBrutto(), 2, ',', '.') }} EUR auf unser, in der Rechnung genanntes, Konto innerhalb der nächsten 5 Arbeitstage.</p>
                                                            <p>Sollten Sie den Rechnungsbetrag in den letzten Tagen bereits überwiesen haben, so betrachten Sie dieses Schreiben bitte als gegenstandslos.</p>
                                                            <p>Im Anhang übersenden wir Ihnen noch einmal Ihre Rechnung vom {{$invoice->date_origin}} als PDF-Dokument.</p>
                                                            <p>Zum Lesen und Ausdrucken der Dokumente im PDF-Format benötigen Sie den Adobe Reader.
                                                                <br>Dieses Programm können Sie unter dem folgenden Link kostenlos herunterladen: <a href="https://get.adobe.com/reader/">https://get.adobe.com/reader/</a></p>
                                                            <p>Sie haben Fragen? Gerne können Sie uns anrufen oder mailen, damit wir Ihre Fragen schnellstmöglich klären.</p>
                                                            <p>Viele Grüße aus Mannheim wünscht Ihnen,</p>
                                                            <p style="font-family: 'Courgette', cursive; color: #212121!important; font-size: 18px;">Michael Klein</p>
                                                        </td>
                                                    </tr>
                                                    <!-- END BODY COPY -->
