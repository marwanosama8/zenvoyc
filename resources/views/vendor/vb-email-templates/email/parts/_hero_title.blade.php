...
<tr>
    <td bgcolor="{{ $data['theme']['header_bg_color'] }}" align="center"
        style="padding: 0px 10px 0px 10px;color: {{ $data['theme']['body_color'] }};">
        <!--[if (gte mso 9)|(IE)]>
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%"
            ...
            <tr>
                <td bgcolor="{{ $data['theme']['content_bg_color'] }}" align="center" valign="top"
                    style="padding: 40px 20px 20px 20px; border-radius: 4px 4px 0px 0px; color: {{ config('filament-email-templates
