...
<tr>
	<td bgcolor="{{$data['theme']["footer_bg_color"]}}" align="center" style="padding: 0px 10px 0px 10px;">
        ...
        <![endif]-->
				<table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: {{$data['configs']['content_width']}}px;">
					<!-- NAVIGATION -->
					<tr>
		                ...
		                font-family: 'Lato', Helvetica, Arial, sans-serif; font-size: 14px; font-weight: 400; line-height: 18px;">
							<p style="margin: 0;">
								@foreach($data['configs']['links'] as $link)
				...
				<table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: {{$data['configs']['content_width']}}px; margin: 20px 0">
					...
					<tr>
						<td bgcolor="{{$data['theme']["body_bg_color"]}}" align="left"
							...
							<p style="margin: 0;"> &copy; <?= date('Y'); ?> {{$data['configs']['company_name']}}. {{__('vb-email-templates::email-templates.general-labels.all-rights-reserved')}}.</p>
						</td>
					</tr>
				</table>
		<!--[if (gte mso 9)|(IE)]>
